...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="assets/img/logo.png"" id="icon" alt="User Icon" /><br><br>
      <h1> Admin Login</h1>
    </div>

  <form action="checkLoginAdmin.php" method="post"> 
      <input type="text" id="username" class="fadeIn second" name="username" placeholder="email / username" required><br>
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="home.php">Go to the Site</a>
    </div>
